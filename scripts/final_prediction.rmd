...
model = lm(pv2p ~ incumbent + incumbent_party * party + average_poll + last_election + approval, data = final)
...
gtsave(finaltable, "../figures/finaltable.html", height = 10, width = 10)
