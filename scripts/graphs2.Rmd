...
ga_dems_model <- lm(ga_unemployment ~ incumbent_voteshare, data = ga_dems)

ga_rep_model <- lm(ga_unemployment ~ incumbent_voteshare, data = ga_reps)
...
us_dems_model <- lm(us_unemployment ~ incumbent_voteshare, data = ga_dems)

us_rep_model <- lm(us_unemployment ~ incumbent_voteshare, data = ga_reps)
