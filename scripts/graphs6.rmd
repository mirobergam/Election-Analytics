...
demog <- demog %>%
  ...
  select(year, state, R_pv2p, asian_chg, black_chg, white_chg,
...
demo_model <- glm(R_pv2p ~ Region + white_chg + hispanic_chg + asian_chg + 
                          black_chg + indigenous_chg + female_chg +
                          male_chg + age20_chg + age3045_chg + 
                          age4565_chg + age65_chg, data = demog)
