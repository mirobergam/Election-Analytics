...
votes_county <- vote_county_2020 %>%
  ...
  mutate(dem_change = D_win_margin_2020 - D_win_margin_2016,
         D_win_margin_2016 = as.numeric(D_win_margin_2016), 
...
votes_county %>%
  ...
  geom_point() +
  labs(y = "Change in Democratic Win Margin ",
       x = "Ratio of COVID Deaths to Overall Deaths",
       title = "COVID Death Ratio by Change in Democratic Win Margin Between 2020 and 2016") + 
...
votes_county %>%
  ...
  labs(y = "Democratic Win Margin in 2020",
       ...
       title = "Democratic Win Margins Between 2016 and 2020",
       color = "COVID Death to \nOverall Death Ratio")

```

Polls v Covid
polls v Actual votes to explain 
